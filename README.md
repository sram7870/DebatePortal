...
Install dependencies: Use the requirements.txt file to install all the necessary Python libraries by running pip install -r requirements.txt.


Run the application: Launch the app by executing python app.py. This should open a local development server and launch the web app in your default browser.
