...
// Modal functions — work for both tasks and tournaments
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (taskSearchInput) {
        ...
        taskSearchInput.addEventListener('input', () => {
            ...
            taskItems.forEach(item => {
                ...
                item.style.display = (title.includes(q) || tag.includes(q)) ? 'block' : 'none';
            });
        });
    }

    // Tournament Search
    const tournamentSearchInput = document.getElementById('tournamentSearch');
    if (tournamentSearchInput) {
        ...
        tournamentSearchInput.addEventListener('input', () => {
            const q = tournamentSearchInput.value.toLowerCase();
            tournamentItems.forEach(item => {
                const name = item.getAttribute('data-name') || '';
                const description = item.getAttribute('data-description') || '';
                item.style.display = (name.includes(q) || description.includes(q)) ? 'block' : 'none';
            });
        });
    }
    ...
    if (folderSearchInput) {
        ...
        folderSearchInput.addEventListener('input', () => {
            const q = folderSearchInput.value.toLowerCase();
